    ...
    .factory('IndexFactory', function($http, $q,$ionicPopup,$ionicLoading){
        return {
            getIndexList: function getIndexList() {
                ...
                var url = 'http://120.27.221.0:8080/yxs?domain=getIndexList';
            ...
            getIndexMain: function getIndexMain() {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/yxs?domain=getListMain';
            ...
            getIndexListByCity: function getIndexListByCity(cityid) {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/yxs?domain=getIndexListByCityName';
                if(cityid!=null)
                    url+='&cityid='+cityid;
                $ionicLoading.show({
                    template: 'Loading...'
            ...
            getArticleDetails: function getArticleDetails(yxsid) {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/yxs?domain=getArticleDetails';
                if(yxsid!=null)
                    url+='&yxsid='+yxsid;
                $ionicLoading.show({
                    template: 'Loading...'
            ...
            getArticleDetailsInfo: function getArticleDetailsInfo(aid) {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/yxs?domain=getArticleDetailsInfo';
                if(aid!=null)
                    url+='&aid='+aid;
                $ionicLoading.show({
                    template: 'Loading...'
            ...
            submitForAdvise: function submitForAdvise(adviseinfo) {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/chats?domain=submitForAdvise';
                if(adviseinfo!=null)
                {
            ...
            getChatsReply: function getChatsReply(sendMessage) {
                var deferred = $q.defer();
                var url = 'http://120.27.221.0:8080/chats?domain=getChatsReply';
                if(sendMessage!=null)
