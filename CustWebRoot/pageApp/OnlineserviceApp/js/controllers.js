       ...
       $scope.createHtml=function(send,reply)
        {
            ...
            html+="<div style='min-height: 50px;padding-left: 20px;padding-top:20px;padding-right:15px;padding-bottom:20px;line-height:150%;max-width:33%;min-width:5%;float: right;background-image: url(img/dialog_box@2x.png);background-size: 100% 100%;background-repeat: no-repeat;white-space: normal;font-size:1em;'>";
            html+=send;
            html+="</div>";
            html+="</div>";
            if(reply!=null) {
                html += "<div class='item' style='width: 100%;border: none;background-color: #EEEEEE;'>";
                html += "<div style='min-height: 50px;min-width: 5%;line-height:150%;max-width:50%;float: left;background-image: url(img/dialog_kf@2x.png);background-size: 100% 100%;background-repeat: no-repeat;white-space: normal;padding-left: 20px;padding-top:20px;padding-right:15px;padding-bottom:20px;font-size:1em;'>";
                html += reply;
                html += "</div>";
                html += "</div>";
            }
