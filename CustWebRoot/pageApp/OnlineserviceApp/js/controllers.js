       ...
       $scope.createHtml=function(send,reply)
        {
            ...
            if(reply!=null) {
                ...
                html += "<div style='min-height: 50px;min-width: 5%;line-height:150%;max-width:50%;float: left;background-image: url(img/dialog_kf@2x.png);background-size: 100% 100%;background-repeat: no-repeat;white-space: normal;padding: 15px;font-size:1em;'>";
                html += reply;
                html += "</div>";
                html += "</div>";
            }
