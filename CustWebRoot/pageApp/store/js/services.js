    ...
    .factory('listFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            getCount: function getCount(userId){
                ...
                var url = 'http://192.168.15.17:8118/service?domain=queryAllCount&userId='+userId;
            ...
            getList: function getList(domain,userId){
                var deferred = $q.defer();
                var url = 'http://192.168.15.17:8118/service?domain='+domain+'&userId='+userId;
                $http.post(url).success(function (response) {
            ...
            getListByDomain: function getListByDomain(domain,uid){
                var deferred = $q.defer();
                var url = 'http://192.168.15.17:8080/store?domain='+domain;
                if(uid!=null)
                     url=url+"&uid="+uid;
                $ionicLoading.show({
                      template: 'Loading...'
    ...
    .factory('detailFactory', function($http, $q){
        ...
        return {
            getList: function getList(domain,demdId){
                var deferred = $q.defer();
                var url = 'http://192.168.15.17:8118/service?domain='+domain+'&demdId='+demdId;
                $http.post(url).success(function (response) {
                    var resultJson = response;
                    var array = [];
            ...
            getWorkRel: function getWorkRel(name,demdId){
                ...
                var url = 'http://192.168.15.17:8118/service?domain=queryWorkRel&name='+DName+'&demdId='+demdId;
                $http.post(url).success(function (response) {
            ...
            getWorkList: function getWorkList(demdId){
                var deferred = $q.defer();
                var url = 'http://192.168.15.17:8118/service?domain=queryWorkDetail&demdId='+demdId;
                $http.post(url).success(function (response) {
            ...
            getCurrentWork: function getCurrentWork(name,demdId){
                var deferred = $q.defer();
                var url = 'http://192.168.15.17:8118/service?domain=queryCurWorkDetail&name=' + name + '&demdId=' + demdId;
                $http.post(url).success(function (response) {
            ...
            queryNextOp:function queryNextOp(name,lanId,currNodeid,workLogId){
                ...
                var DName = eval('JName.'+name);
                var url = 'http://192.168.15.17:8118/service?domain=queryNextOp&name='+DName+'&lanId='+lanId+'&userId='+currNodeid+'&demdId='+workLogId;
                alert(url)
                $http.post(url).success(function (response) {
            ...
            goNextWork: function goNextWork(state, userId, currNodeId, workLogId, lastNodeId, doWhat,doId, lanId, yornToStart, workRelId, remarks, yornSms){
                ...
                var url = 'http://192.168.15.17:8118/service?domain=doWork&state=' + state + '&userId=' + userId + '&currNodeId=' + currNodeId + '&workLogId=' + workLogId + '&lastNodeId=' + lastNodeId + '&name=' + DName + '&demdId=' + doId + '&lanId=' + lanId + '&yornToStart=' + yornToStart + '&workRelId=' + workRelId + '&remarks=' + remarks + '&yornSms=' + yornSms;
                $http.post(url).success(function (response) {
    ...
    .factory('loginFactory', function($http, $q,$ionicLoading){
        return {
            doLogin: function doLogin(username,password){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=doLogin&username='+username+'&password='+password;
                $http.post(url).success(function (response) {
                    $ionicLoading.hide();
    ...
    .factory('categorylistFactory', function($http, $q,$ionicLoading){
        return {
            getCategorylist: function getCategorylist(dicid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getCategorylist&dicid='+dicid;
                $http.post(url).success(function (response) {
                    $ionicLoading.hide();
                    var resultJson = response;
                    var array = [];
    ...
    .factory('commendlistFactory', function($http, $q,$ionicLoading){
        return {
            getCommendlist: function getCommendlist(){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getMain';
                $http.post(url).success(function (response) {
                    $ionicLoading.hide();
    ...
    .factory('goodslistFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            getGoodslist: function getGoodslist(clarifyId,startpage,curpage,param){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getGoodslist&clarifyId='+clarifyId+'&startpage='+startpage+'&endpage='+curpage;
                if(param!=null)
    ...
    .factory('cartFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            ...
            addCart: function addCart(gid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=addCart&gid='+gid;
            ...
            addCartNumber: function addCartNumber(gid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=addCartNumber&gid='+gid;
            ...
            minusCartNumber: function minusCartNumber(gid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=minusCartNumber&gid='+gid;
          ...
          delCart: function delCart(gid){
              ...
              var url = 'http://192.168.15.17:8080/store?domain=delCart&gid='+gid;
    ...
    .factory('goodsDetailFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            getGoodsdetail: function getGoodsdetail(gid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getGoodsdetail&gid='+gid;
//                if(param!=null)
//                    url=url+"&orderparam="+param;
                $http.post(url).success(function (response) {
                    $ionicLoading.hide();
    ...
    .factory('ConfirmOrderFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            ...
            acquirePersonalInfo: function acquirePersonalInfo(cartidlist){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=acquireConfirmOrderInfo&idlist='+cartidlist;
//                if(param!=null)
//                    url=url+"&orderparam="+param;
                $http.post(url).success(function (response) {
                    $ionicLoading.hide();
    ...
    .factory('DiscountFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            ...
            getCouponlist: function getCouponlist(status){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getDiscountByUser';
                if(status!=null)
    ...
    .factory('OrderFactory', function($http, $q,$ionicPopup,$ionicLoading){
        ...
        return {
            ...
            produceNotPayOrder:function produceNotPayOrder(cartidlist,cartallprice,UC_ID,paramlist,couponid){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=produceNotPayOrder';
                if(cartidlist!=null)
            ...
            getPayOrderByStatus:function getPayOrderByStatus(orderstatus){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getPayOrderByStatus';
                if(orderstatus!=null)
           ...
           //改变订单状态
            ...
            modifyPayOrder:function modifyPayOrder(O_ORDERID,orderstatus,allprice){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=modifyPayOrder';
            ...
            getOrderDetail:function getOrderDetail(O_ORDERID){
                ...
                var url = 'http://192.168.15.17:8080/store?domain=getOrderDetailById';
                if(O_ORDERID==null)
                {
                    alert("系统错误");
                    deferred.reject();
